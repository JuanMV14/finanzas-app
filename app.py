    ...
    if not trans:
        ...
        with col_gas:
            ...
            if gastos.empty:
                ...
                for idx, row in gastos.iterrows():
...
with tabs[3]:
    ...
    with st.form("nuevo_credito"):
        ...
        monto = st.number_input("Monto", min_value=0.01, key="monto_credito")
        tasa = st.number_input("Tasa de interés (%)", min_value=0.0, key="tasa_credito")
